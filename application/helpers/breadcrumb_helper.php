...
function create_breadcrumb()
{
  $ci = &get_instance();
  $return = '';
  $dashboard_link = '<a href="'.site_url('home').'"><i class="fa fa-home"></i> '.lang('common_dashboard').'</a>';
  ...
  elseif($ci->uri->segment(1) == 'reports')
  {
    ...
    if($ci->uri->segment(2) == 'graphical_summary_categories' || $ci->uri->segment(2) == 'summary_categories' || $ci->uri->segment(2) == 'summary_categories_customers')
    {
    ...
    elseif($ci->uri->segment(2) == 'graphical_summary_customers' || $ci->uri->segment(2) == 'summary_customers' || $ci->uri->segment(2) == 'summary_customers_location' )
    {
      if ($ci->uri->segment(2) == 'summary_customers_location')
      {
        $return.=create_report_breadcrumb(lang('reports_customers_location_summary_report'));
      }
      else 
      {
    ...
    elseif($ci->uri->segment(2) == 'specific_location_store_account')
    {
      $return.=create_report_breadcrumb(lang('reports_detailed_store_accounts_report'));
    }
