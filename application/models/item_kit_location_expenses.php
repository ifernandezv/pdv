<?php
class Item_kit_location_expenses extends CI_Model
{
  ...
  function exists($item_kit_id,$location=false)
  {
    ...
    $this->db->from('location_item_kits_expenses');
  ...
  function save($item_location_data,$item_kit_id=-1,$location_id=false)
  {
    ...
    {
      return $this->db->insert('location_item_kits_expenses',$item_location_data);
    }

    $this->db->where('item_kit_id',$item_kit_id);
    $this->db->where('location_id',$location_id);
    return $this->db->update('location_item_kits_expenses',$item_location_data);
  ...
  function get_info($item_kit_id,$location=false)
  {
    ...
    else
    {
      ...
      $fields = $this->db->list_fields('location_item_kits_expenses');
