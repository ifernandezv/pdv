...
class Location extends CI_Model
{
  ...
  */
  ...
  function get_total_account($location_id, $start_date, $end_date)
  {
    $this->db->select('sum(transaction_amount) as total', false);
    ...
    {
      $return += to_currency_no_money($row['total'],2);
    }
    return $return;
  }
  ...
  */
  ...
  function get_locationid_search_suggestions_2($search,$limit=25)
  {
  $suggestions = array();
