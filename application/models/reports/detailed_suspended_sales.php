...
class Detailed_suspended_sales extends Report
{
  ...
  public function getDataColumns()
  {
    ...
    $return['summary'][] = array('data'=>lang('reports_type'), 'align'=> 'right');
  ...
  public function getData()
  {
    ...
    $this->db->select('sales_items_temp.sale_id, register_name, sales_items_temp.sale_time, sales_items_temp.sale_date, sum(quantity_purchased) as items_purchased, CONCAT(sold_by_employee.first_name," ",sold_by_employee.last_name) as sold_by_employee, CONCAT(employee.first_name," ",employee.last_name) as employee_name, customer.person_id as customer_id, CONCAT(customer.first_name," ",customer.last_name) as customer_name, sum(subtotal) as subtotal, sum(total) as total, sum(tax) as tax, sum(profit) as profit, sales_items_temp.payment_type, sales_items_temp.comment, sales.suspended', false);
