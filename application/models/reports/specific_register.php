...
class Specific_register extends Report
{
  ...
  public function getData()
  {
    ...
    $this->db->select('sale_id, sale_time, register_name, employee_id, sale_date, sum(quantity_purchased) as items_purchased, CONCAT(first_name," ",last_name) as customer_name, sum(subtotal) as subtotal, sum(total) as total, sum(tax) as tax, sum(profit) as profit, payment_type, comment', false);
  ...
  public function getSummaryData()
  {
    ...
    $return = array(
      'total' =>$cash_register->cash_sales_amount ,
      'tax' => 0,
      'profit' => 0,
    );
