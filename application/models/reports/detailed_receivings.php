...
class Detailed_receivings extends Report
{
  ...
  public function getData()
  {
    ...
    $this->db->select('name, receiving_id, receiving_date, items.category, quantity_purchased, serialnumber,total, discount_percent,items.product_id, items.size', false);
    $this->db->from('receivings_items_temp');
