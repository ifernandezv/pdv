<?php
class Item_kit_items_expenses extends CI_Model
{
  /*
  ...
  */
  ...
  {
    $this->db->from('item_kit_items_expenses');
  ...
  */
  function save(&$item_kit_items_data, $item_kit_id)
  {
    ...
    foreach ($item_kit_items_data as $row)
    {
      ...
      $this->db->insert('item_kit_items_expenses',$row);    
    }
  ...
  */
  ...
  {
    return $this->db->delete('item_kit_items_expenses', array('item_kit_id' => $item_kit_id)); 
  }
