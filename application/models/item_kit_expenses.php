<?php
class Item_kit_expenses extends CI_Model
{
  /*
  ...
  */
  function get_all($limit=10000, $offset=0,$col='name',$ord='asc')
  {
    ...
    $this->db->select('item_kits_expenses.*,
    location_item_kits_expenses.unit_price as location_unit_price,
    location_item_kits_expenses.cost_price as location_cost_price');    
    $this->db->from('item_kits_expenses');
    $this->db->join('location_item_kits_expenses', 'location_item_kits_expenses.item_kit_id = item_kits_expenses.item_kit_id and location_id = '.$current_location, 'left');
  ...
  */
  function get_info($item_kit_id)
  {
    ...
    if (!is_numeric($item_kit_id))
    {
      ...
      $fields = $this->db->list_fields('item_kits_expenses');
