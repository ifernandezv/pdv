              ...
              if ( ! isset($lang[$key]) or $lang[$key] == 'NOT_TRANSLATED' or $lang[$key] == $lang_ref[$key])
              {
                ...
                elseif($lang[$key] == $lang_ref[$key])
                {
                  $white_list = array(
                      ...
                      'reports_giftcards', 'sales_description_abbrv', 'sales_stock', 'sales_type', 'sales_signature', 'sales_item_number','sales_store_account','sales_cuotainicial','sales_amortizacion','sales_serial', 'common_powered_by',
                      ...
                      'sales_total', 'receivings_total','config_spreadsheet_format', 'config_csv','config_xlsx', 'sales_layaway', 'reports_total','reports_taxes',
                      'common_website', 'common_det', 'common_update', 'common_barcode_labels', 'common_dashboard', 'config_website', 'config_backup_database', 'config_mailchimp_api_key', 'config_merchant_password', 
                      'item_kits_successful_updating', 'items_upc_database', 'items_product_id', 'items_clone', 'login_go', 'login_login','reports_type','reports_month_11',
                      'reports_month_12', 'reports_sales_generator_selectCondition_1', 'reports_sales_generator_selectCondition_5', 'reports_credit', 'reports_subtotal','sales_sub_total', 'config_application_settings_info', 'config_medium', 'item_id'
