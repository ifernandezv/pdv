<?php $this->load->view("partial/header"); ?>
  <div id="content-header" class="hidden-print">
    <h1> <i class="fa fa-upload"></i> <?php echo lang('import_export_batch_receivings'); ?>  </h1>
  </div>
      ...
      <div class="col-md-12">
        <div class="widget-box">
          ...
          <div class="widget-content">
            ...
            <a class="btn btn-info btn-sm " href="<?php echo site_url('receivings/excel'); ?>"><?php echo lang('download_excel_template_batch_receivings'); ?></a>
              ...
              $(form).ajaxSubmit({
                success:function(response)
                {
                  ...
                  else
                  {
                    ...
                    window.location.href="<?php echo base_url(); ?>index.php/receivings";
                  }
                  submitting = false;
                },
                dataType:'json',
