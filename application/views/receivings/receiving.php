    ...
    <div class="row">
      ...
      <div class="sale_register_leftbox col-md-9 receiving_register_leftbox no-padd">
            ...
            <div class="input-append">
              <?php echo form_open("receivings/add",array('id'=>'add_item_form', 'autocomplete'=> 'off')); ?>
                <?php echo form_input(array('name'=>'item','id'=>'item','size'=>'30','placeholder'=>'Enter item name or scan barcode'));?>
                    ...
                    "<div class='small_button'>".lang('receivings_suspended_receivings')."</div>",
                    array('class'=>'btn btn-primary none suspended_recvs_btn','title'=>lang('receivings_suspended_receivings')));
                    ?>                  
              </form>
            </div>
          </div>
                  ...
                  foreach(array_reverse($cart, true) as $line=>$item)
                  {
                    ...
                    $cur_item_location_info = isset($item['item_id']) ? $this->Item_location->get_info($item['item_id']) : $this->Item_kit_location->get_info($item['item_kit_id']);?>    
                      ...
                      <tr id="reg_item_top">
                        ...
                        <td id="reg_item_name"><?php echo H($item['name']); ?><?php echo $item['size'] ? ' ('.H($item['size']).')': ''; ?></td>
                      ...
                      ?>
                        ...
                        <td id="reg_item_total"><?php echo to_currency($item['price']*$item['quantity']-$item['price']*$item['quantity']*$item['discount']/100, 10); ?></td>
                      </tr>
        ...
        <li>
          ...
          "<div class='small_button'>".lang('batch_receivings')."</div>",
          array('class'=>'btn btn-primary none suspended_recvs_btn hidden-xs','title'=>lang('batch_receivings_title')));
          ?>
      ...
      <li class="list-group-item nopadding">
        ...
        <div class="sale_form_main"   <?php if(count($cart) > 0){ echo "style='visibility: visible;'";}?>>
          <?php  if(count($cart) > 0){ ?>
            ...
            <div class='btn btn-warning width_full' id='suspend_recv_button'>
              <span>
        ...
        <div id='sale_details'>
          <table id="sales_items_total" class="table">
            <tr class="success">
              ...
              <td class="right"><h4><?php echo to_currency($total, 10); ?></h4></td>
            </tr>
          </table>
        </div>
        ...
        if(count($cart) > 0){ ?>
          ...
          <div id="finish_sale">
            ...
            <div style="padding: 0 10px 0 10px;">
              ...
              <?php echo form_textarea(array('name'=>'comment', 'id' => 'comment', 'value'=>$comment,'rows'=>'4'));?>
