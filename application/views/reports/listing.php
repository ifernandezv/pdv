    ...
    <div class="panel">
      <div class="panel-body">
        <div class="list-group parent-list">
          ...
          {
          ?>
            <a href="#" class="list-group-item" id="commissions"><i class="fa fa-money"></i>  <?php echo lang('reports_commission'); ?></a>
          <?php } ?>
          ...
          {
          ?>
            <a href="#" class="list-group-item" id="suspended_sales"><i class="fa fa-download"></i>  <?php echo lang('reports_suspended_sales'); ?></a>
          <?php } ?>
      ...
      <h3 class="page-header text-info">&laquo; <?php echo lang('reports_make_a_selection')?></h3>
        ...
        <div class="list-group customers hidden">
          ...
          <a class="list-group-item" href="<?php echo site_url('reports/summary_customers');?>" ><i class="fa fa-building-o"></i> <?php echo lang('reports_summary_reports'); ?></a>
                    <a class="list-group-item" href="<?php echo site_url('reports/summary_customers_location');?>" ><i class="fa fa-map-marker"></i> <?php echo lang('reports_summary_reports_location'); ?></a>
        ...
        <div class="list-group commissions hidden">
          <a class="list-group-item" href="<?php echo site_url('reports/graphical_summary_commissions');?>" ><i class="fa fa-bar-chart-o"></i> <?php echo lang('reports_graphical_reports'); ?></a>
          <a class="list-group-item" href="<?php echo site_url('reports/summary_commissions');?>" ><i class="fa fa-building-o"></i> <?php echo lang('reports_summary_reports'); ?></a>
          <a class="list-group-item" href="<?php echo site_url('reports/detailed_commissions');?>" ><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports'); ?></a>
        </div>
        ...
        <div class="list-group register-log hidden">
          <a href="<?php echo site_url('reports/specific_register');?>" class="list-group-item"><i class="fa fa-calendar"></i> <?php echo lang('reports_specific_register'); ?></a>
        </div>
                <div class="list-group register-log hidden">
        ...
        <div class="list-group categories hidden">
          ...
          <a href="<?php echo site_url('reports/summary_categories');?>" class="list-group-item"><i class="fa fa-building-o"></i> <?php echo lang('reports_summary_reports'); ?></a>
                    <a href="<?php echo site_url('reports/summary_categories_customers');?>" class="list-group-item"><i class="fa fa-building-o"></i> <?php echo lang('reports_detailed_reports'); ?></a>
        </div>
        ...
        <div class="list-group payments hidden">
          ...
          <a href="<?php echo site_url('reports/detailed_payments');?>" class="list-group-item"><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports'); ?></a>
        </div>
        ...
        <div class="list-group suspended_sales hidden">
          <a href="<?php echo site_url('reports/detailed_suspended_sales');?>" class="list-group-item"><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports'); ?></a>
        </div>
        ...
        <div class="list-group inventory hidden">
          ...
          <a class="list-group-item" href="<?php echo site_url('reports/detailed_inventory');?>" ><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports'); ?></a>
        </div>
        ...
        <div class="list-group store-accounts hidden">
          ...
          <a href="<?php echo site_url('reports/specific_customer_store_account');?>" class="list-group-item"><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports_customer'); ?></a>
                    <a href="<?php echo site_url('reports/specific_location_store_account');?>" class="list-group-item"><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports_location'); ?></a>
        </div>
