...
?>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
    <?php echo form_label(lang('locations_location_id').' :', 'locationid_input', array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label   ')); ?> 
    <div class="col-sm-9 col-md-9 col-lg-10">
      <?php echo form_input(array(
        'name'=>'locationid_input',
        'id'=>'locationid_input',
        'size'=>'10',
        'value'=>''));
      ?>                  
...
$(document).ready(function()
{
  ...
  $("#locationid_input").select2(
  {
    placeholder: <?php echo json_encode(lang('common_search')); ?>,
    id: function(suggestion){ return suggestion.value; },
    ajax: {
      url: <?php echo json_encode($search_suggestion_url_2); ?>,
      dataType: 'json',
       data: function(term, page) 
      {
          return {
  ...
  $("#generate_report").click(function()
  {
    ...
    var location_id = $("#locationid_input").val() ? $("#locationid_input").val() : -1;
    ...
    {
      window.location = window.location+'/'+customer_id+'/'+location_id+'/'+$("#report_date_range_simple option:selected").val()+ '/'+hide_items + '/'+pull_payments_by;
    }
    else
    {
      ...
      window.location = window.location+'/'+customer_id+'/'+location_id+'/'+start_date+'/'+end_date+'/'+hide_items + '/'+pull_payments_by;
    }
