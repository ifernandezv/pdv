            ...
            <div id='report_date_range_complex'>
              <div class="form-group">
                ...
                <div class="col-sm-9 col-md-9 col-lg-10">
                  ...
                  <div class="mobile_break">&nbsp;</div>
                  <?php echo form_dropdown('end_hour',$hours, 23, 'id="end_hour" class="input-small-mobiles"'); ?>
                  :
                  <?php echo form_dropdown('end_minute',$minutes, '59', 'id="end_minute" class="input-small-mobiles"'); ?>
                </div>
              </div>
            </div>
...
<?php $pos = strpos($_SERVER['REQUEST_URI'], 'detailed_commissions'); 
if ($pos !== false) {?>
<div class="form-group">
              <?php echo form_label('Incluir Excedentes :', 'reports_i_excedentes', array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?> 
              <div class="col-sm-9 col-md-9 col-lg-10">
                <input type="radio" name="i_excedentes" id="i_excedentes_yes" value='1' /> <?php echo lang('common_yes'); ?>  &nbsp;&nbsp;
                <input type="radio" name="i_excedentes" id="i_excedentes_no" value='0' checked='checked' /> <?php echo lang('common_no'); ?>
              </div>
            </div>
...
<?php }?>
            ...
            <div class="form-group">
              <?php echo form_label(lang('employees_employee_type').' :', 'reports_employee_type_label', array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?> 
              <div class="col-sm-9 col-md-9 col-lg-10">
                <?php echo form_dropdown('employee_type',array( 'sale_person' => lang('employees_sale_person'), 'logged_in_employee' => lang('employees_logged_in_employee')), 'sale_person', 'id="employee_type" class="input-medium"'); ?>
              </div>
            </div>
...
if ($pos !== false) {?>
      ...
      if ($("#i_excedentes_yes").prop('checked'))
      {
        i_excedentes = 1;
      }
      ...
      {
        window.location = window.location+'/'+$("#report_date_range_simple option:selected").val()+ '/' + specific_id + '/' + sale_type + '/' + employee_type + '/' + export_excel  + '/' + i_excedentes;
      }
      else
      {
        ...
        window.location = window.location+'/'+start_date + '/'+ end_date + '/' + specific_id + '/' + sale_type + '/' + employee_type + '/'+ export_excel + '/' + i_excedentes;
      }
      <?php } else { ?>
