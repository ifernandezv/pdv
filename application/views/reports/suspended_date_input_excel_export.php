      ...
      <div class="widget-content nopadding">
        ...
        <form  class="form-horizontal form-horizontal-mobiles">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 col-md-9 col-lg-10">
              <?php echo form_dropdown('sale_type',array('all' => lang('reports_all'), 'layaway' => lang('sales_layaway'), 'estimate' => lang('sales_estimate')), 'all', 'id="sale_type" class="input-medium"'); ?>
            </div>
          </div>
