<?php $this->load->view("partial/header"); ?>
  <div id="content-header" class="hidden-print">
    <h1> <i class="fa fa-upload"></i> <?php echo lang('suppliers_import_suppliers_from_excel'); ?>  </h1>
  </div>
      ...
      <div class="col-md-12">
        <div class="widget-box">
          ...
          <div class="widget-content">
            ...
            <?php echo form_open_multipart('suppliers/do_excel_import/',array('id'=>'item_form','class'=>'form-horizontal')); ?>
            <h2><?php echo lang('common_step_1'); ?>: </h2>
            <p><?php echo lang('suppliers_step_1_desc'); ?></p>


            <a class="btn btn-info btn-sm " href="<?php echo site_url('suppliers/excel'); ?>"><?php echo lang('suppliers_new_suppliers_import'); ?></a>
