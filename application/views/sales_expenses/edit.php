<?php $this->load->view("partial/header"); ?>
  ...
  <?php echo form_open("sales_expenses/save/".$sale_info['sale_id'],array('id'=>'sales_edit_form','class'=>'form-horizontal')); ?>
  ...
  <div class="form-group">  
    ...
    <div class="col-sm-9 col-md-9 col-lg-10 sale-s">
      <?php echo anchor('sales_expenses/receipt/'.$sale_info['sale_id'], $this->config->item('sale_prefix').' '.$sale_info['sale_id'], array('target' => '_blank'));?>
    </div>
  </div>
  ...
  <div class="form-group">  
    ...
    <div class="col-sm-9 col-md-3 col-lg-4 sale-s">
      ...
      <?php if ($sale_info['customer_id']) { ?>
        <?php echo anchor('sales_expenses/email_receipt/'.$sale_info['sale_id'], lang('sales_email_receipt'), array('id' => 'email_receipt'));?>
      <?php }?>
    </div>
  </div>
  ...
  {
  ?>
  <?php echo form_open("sales_expenses/undelete/".$sale_info['sale_id'],array('id'=>'sales_undelete_form','class'=>'form-horizontal')); ?>
  ...
  echo form_open("sales_expenses/$edit_sale_url/".$sale_info['sale_id'],array('id'=>'sales_change_form','class'=>'form-horizontal')); ?>
  ...
  <?php
     if (!$store_account_payment && $this->Employee->has_module_action_permission('sales_expenses', 'delete_sale', $this->Employee->get_logged_in_employee_info()->person_id))
    { 
         echo form_open("sales_expenses/delete/".$sale_info['sale_id'],array('id'=>'sales_delete_form','class'=>'form-horizontal')); ?>
