...
<div id="receipt_wrapper">
  <div id="receipt_header">
    ...
    <div class="pull-right"><button class="btn btn-primary text-white hidden-print" id="new_sale_button_1" onclick="window.location='<?php echo site_url('sales_expenses'); ?>'" > <?php echo lang('sales_new_sale'); ?> </button></div>
  </div>
