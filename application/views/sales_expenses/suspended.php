<?php $this->load->view("partial/header");
  $controller_name="items_expenses";
 ?>
      ...
      <div class="col-md-12">
        <div class="widget-box">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover data-table" id="dTable_r">
        <thead>  <tr>
          ...
          <?php if ($this->Employee->has_module_action_permission('sales_expenses', 'delete_suspended_sale', $this->Employee->get_logged_in_employee_info()->person_id)){ ?>
        ...
        ?>
          <tr>
            ...
            <td >
              <?php 
              echo form_open('sales_expenses/unsuspend');
            ...
            <td>
              <?php 
              echo form_open('sales_expenses/receipt/'.$suspended_sale['sale_id'], array('method'=>'get', 'class' => 'form_receipt_suspended_sale'));
              ?>
            ...
            {
              echo form_open('sales_expenses/email_receipt/'.$suspended_sale['sale_id'], array('method'=>'get', 'class' => 'form_email_receipt_suspended_sale'));
              ?>
            ...
            <td>
              <?php 
               ...
               echo form_open('sales_expenses/delete_suspended_sale', array('class' => 'form_delete_suspended_sale'));
              echo form_hidden('suspended_sale_id', $suspended_sale['sale_id']);
              ?>
