<?php $this->load->view("partial/header"); ?>
  <div id="content-header" class="hidden-print">
    <h1> <i class="fa fa-upload"></i> <?php echo lang('import_export_batch_sale'); ?>  </h1>
  </div>
      ...
      <div class="col-md-12">
        <div class="widget-box">
          <!--div class="widget-title">
            ...
            <h5><?php echo lang('suppliers_mass_import_from_excel'); ?></h5>
          </div-->
          <div class="widget-content">
            <ul class="text-error" id="error_message_box"></ul>
            <?php echo form_open_multipart('sales_expenses/do_excel_import/',array('id'=>'item_form','class'=>'form-horizontal')); ?>
            <h2><?php echo lang('common_step_1'); ?>: </h2>
            <p><?php echo lang('download_file_batch_sale'); ?></p>
            
          
            <a class="btn btn-info btn-sm " href="<?php echo site_url('sales_expenses/excel'); ?>"><?php echo lang('download_excel_template_batch_sale'); ?></a>
            <?php //echo lang('common_or');?>
            <!--a class="btn btn-info btn-sm " href="<?php echo site_url('suppliers/excel_export'); ?>"><?php echo lang('suppliers_update_suppliers_import'); ?></a-->
              ...
              $(form).ajaxSubmit({
                success:function(response)
                {
                  ...
                  else
                  {
                    ...
                    window.location.href="<?php echo base_url(); ?>index.php/sales_expenses";
                  }
                  submitting = false;
                },
                dataType:'json',
