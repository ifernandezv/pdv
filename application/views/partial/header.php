...
<html>
  ...
  <body data-color="grey" class="flat">
    ...
    <div id="wrapper" <?php echo $this->uri->segment(1)=='sales' || $this->uri->segment(1)=='sales_expenses' || $this->uri->segment(1)=='receivings'  ? 'class="minibar"' : ''; ?> >
    <div id="header" class="hidden-print">
      <h1><a href="<?php echo site_url('home'); ?>"><?php echo img(
        array(
    ...
    $sidebar_class = "";
    $sales_content_class = "";
    if ($this->router->fetch_class() == "sales" || $this->router->fetch_class() == "sales_expenses" || $this->router->fetch_class() == "receivings") {
