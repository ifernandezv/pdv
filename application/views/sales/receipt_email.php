...
<body>
  ...
  ?>
  <th style="width:16%;<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>"><?php echo lang('sales_total'); ?></th>
  </tr>
  <?php
  foreach(array_reverse($cart, true) as $line=>$item)
  {
  ?>
    ...
    ?>
    <td style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>'><?php echo to_currency($item['price']*$item['quantity']-$item['price']*$item['quantity']*$item['discount']/100); ?></td>
    </tr>
  ...
  ?>
  <tr>
  <td colspan="4" style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>;border-top:2px solid #000000;'><?php echo lang('sales_sub_total'); ?></td>
  ...
  <?php foreach($taxes as $name=>$value) { ?>
    <tr>
      <td colspan="4" style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>'><?php echo $name; ?>:</td>
      <td colspan="2" style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>'><?php echo to_currency($value); ?></td>
    </tr>
  <?php }; ?>

  <tr>
  <td colspan="4" style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>'><?php echo lang('sales_total'); ?></td>
  ...
  <tr>
    ...
    <td colspan="2" style="<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>"><?php echo $payment['payment_type'];?> </td>
  ...
  <tr>
    <td colspan="4" style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>'><?php echo lang('sales_change_due'); ?></td>
  ...
  ?>
  <tr>
    <td colspan="4" style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>'><?php echo lang('sales_amount_due'); ?></td>
  ...
  <tr>
    <td colspan="4" style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>'><?php echo lang('sales_customer_account_balance'); ?></td>
  ...
  ?>
  <tr>
    <td colspan="4" style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>'><?php echo lang('sales_ref_no'); ?></td>
  ...
  ?>
  <tr>
    <td colspan="4" style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>'><?php echo lang('sales_auth_code'); ?></td>
