...
$(document).ready(function()
{
  ...
  enable_select_all();
    ...
    $('#generate_barcodes').click(function()
    {
      ...
      $(this).attr('href','<?php echo site_url("item_kits_expenses/generate_barcodes");?>/'+selected.join('~'));
    });
    ...
    $('#generate_barcode_labels').click(function()
    {
      ...
      $(this).attr('href','<?php echo site_url("item_kits_expenses/generate_barcode_labels");?>/'+selected.join('~'));
    });
      ...
      <div class="col-md-12 ">          
        <div class="btn-group  ">
          ...
          '<i class="fa fa-download fa fa-2x hidden-lg tip-bottom" data-original-title="'.lang("common_excel_export").'"></i> <span class="visible-lg">'.lang("common_excel_export").'</span>',
            array('class'=>'btn btn-primary import ','title'=>lang('common_excel_export')));
          ?>
        </div>
      </div>
    </div>
