    ...
    <div class="col-md-12">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <div class="form-group">  
          <?php echo form_label(lang('items_additional_item_numbers').':', 'additional_item_numbers',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
            <div class="col-sm-9 col-md-9 col-lg-10">
          ...
          <div class="form-group">
          <?php echo form_label(lang('items_size').':', 'size',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
            <div class="col-sm-9 col-md-9 col-lg-10">
            <?php echo form_input(array(
              'name'=>'size',
              'id'=>'size',
      ...
      <div class="widget-title widget-title1 pricing-widget">
        ...
        <div class="commission-container <?php if (!($item_info->commission_percent > 0) && !($item_info->commission_fixed > 0)){echo 'hidden';} ?>">
          <p style="margin-top: 10px;"><?php echo lang('common_commission_help');?></p>
            ...
            <?php echo form_dropdown('commission_type', array('percent' => lang('common_percentage'), 'fixed' => lang('common_fixed_amount')), $item_info->commission_fixed > 0 ? 'fixed' : 'percent');?>
            </div>
          </div>
