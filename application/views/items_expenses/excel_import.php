...
<div id="content-header" class="hidden-print">
    <h1> <i class="fa fa-upload"></i> <?php echo lang('items_mass_import_from_excel'); ?>  </h1>
</div>
    ...
    <div class="col-md-12">
      <div class="widget-box">
        <div class="widget-title">
          ...
          <h5><?php echo lang('items_mass_import_from_excel'); ?></h5>
        ...
        <div class="widget-content">
          ...
          <a class="btn btn-info btn-sm " href="<?php echo site_url('items/excel'); ?>"><?php echo lang('items_new_items_import'); ?></a>
          <?php echo lang('common_or');?>
          <a class="btn btn-info btn-sm " href="<?php echo site_url('items/excel_export'); ?>"><?php echo lang('items_update_items_import'); ?></a>
