        ...
        <div class="widget-content nopadding">
          <div class='modal-body modal-body-popup'>
            <?php echo form_open('items/bulk_update/',array('id'=>'bulk_item_form','class'=>'form-horizontal')); ?>
              ...
              <div class="control-group control-group-popup">  
              <?php echo form_label(lang('items_cost_price').':', 'cost_price',array('class'=>'control-label')); ?>
                <div class="controls controls-popup">
                <?php echo form_input(array(
                  'name'=>'cost_price',
                  'id'=>'cost_price')
              ...
              <div class="control-group control-group-popup">  
              <?php echo form_label(lang('items_unit_price').':', 'unit_price',array('class'=>'control-label')); ?>
                <div class="controls controls-popup">
                <?php echo form_input(array(
                  'name'=>'unit_price',
                  'id'=>'unit_price')
              ...
              <div class="control-group control-group-popup">  
              <?php echo form_label(lang('items_promo_price').':', 'promo_price',array('class'=>'control-label')); ?>
                <div class="controls controls-popup">
                <?php echo form_input(array(
                  'name'=>'promo_price',
                  'id'=>'promo_price')
