      ...
      <div class="col-md-12">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            <div class="form-group">  
            <?php echo form_label(lang('locations_registers').':', 'registers',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
              <div class="col-sm-9 col-md-9 col-lg-10">
              <table id="price_registers">
              <thead>
                <tr>
              ...
              <?php foreach($registers->result() as $register) { ?>
                <tr><td><input type="text" name="registers_to_edit[<?php echo $register->register_id; ?>]" value="<?php echo H($register->name); ?>" /></td><td>
            ...
            <div class="form-group">
            <?php echo form_label("<a href='http://www.mercurypay.com' target='_blank'>".$this->lang->line('config_enable_credit_card_processing').'</a>:', 'enable_credit_card_processing',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
              <div class="col-sm-9 col-md-9 col-lg-10">
            ...
            <div class="form-group">  
            <?php echo form_label(anchor('http://mailchimp.com', lang('config_mailchimp_api_key'), array('target' => '_blank')).':', 'mailchimp_api_key',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
              <div class="col-sm-9 col-md-9 col-lg-10">
              <?php echo form_input(array(
                'class'=>'form-control form-inps',
...
<script type='text/javascript'>
  var submitting = false;
    ...
    $(document).ready(function()
    {
      ...
      {
        $("#price_registers tbody").append('<tr><td><input type="text" class="registers_to_add" name="registers_to_add[]" value="" /></td><td>&nbsp;</td></tr>');
      });
      ...
      $('#location_form').validate({
        submitHandler:function(form)
        {
          ...
          success:function(response)
          {
            ...
            gritter(response.success ? <?php echo json_encode(lang('common_success')); ?> +' #' + response.location_id : <?php echo json_encode(lang('common_error')); ?> ,response.message,response.success ? 'gritter-item-success' : 'gritter-item-error',false,false);
