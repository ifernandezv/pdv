...
class Mcapi {
     ...
     * 
     * @param array $params associative array containing apikey and secure
     */
    function Mcapi($params) {
        $this->secure = isset($params['secure']) ? $params['secure'] : false;
        $this->apiUrl = parse_url("http://api.mailchimp.com/" . $this->version . "/?output=php");
        $this->api_key = isset($params['apikey']) ? $params['apikey'] : false;
    }
