...
class CI_Session {
    ...
    */
    function _sess_run()
    {
      session_name($this->object->config->item('sess_cookie_name') ? $this->object->config->item('sess_cookie_name') : 'phppos');
        session_start();
      
      if ($this->userdata('domain') || (isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST']))
      {
